...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleInviteLink'>;
...
export default function ScheduleInviteLinkScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Public invite link</Text>
        <Text style={styles.heroSubtitle}>Generate, copy and share a public link.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Public invite link</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Generate, copy and share a public link. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleInviteLink • Page {page + 1}
        </Text>
      </View>
