 ...
 *
 * Screen: ScheduleNewMeetingDetails
 * Stack:  schedule
 * Depth:  Level 3
 */
...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleNewMeetingDetails'>;
...
export default function ScheduleNewMeetingDetailsScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Meeting details</Text>
        <Text style={styles.heroSubtitle}>Title, description, agenda, category.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Meeting details</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Title, description, agenda, category. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleNewMeetingDetails • Page {page + 1}
        </Text>
      </View>
