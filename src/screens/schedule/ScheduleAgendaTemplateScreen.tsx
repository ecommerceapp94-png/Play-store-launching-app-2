...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleAgendaTemplate'>;
...
export default function ScheduleAgendaTemplateScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ScheduleNewMeeting-0',
      label: "Use this template",
      subtitle: "Start a meeting with this agenda",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Agenda template</Text>
        <Text style={styles.heroSubtitle}>A pre-made plan you can drop into a new meeting.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Agenda template</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>A pre-made plan you can drop into a new meeting. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleAgendaTemplate • Page {page + 1}
        </Text>
      </View>
