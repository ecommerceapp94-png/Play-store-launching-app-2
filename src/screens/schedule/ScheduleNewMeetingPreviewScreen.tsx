 ...
 *
 * Screen: ScheduleNewMeetingPreview
 * Stack:  schedule
 * Depth:  Level 4
 */
...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleNewMeetingPreview'>;
...
export default function ScheduleNewMeetingPreviewScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ScheduleIndex-0',
      label: "Done",
      subtitle: "Return to the calendar view",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Preview & schedule</Text>
        <Text style={styles.heroSubtitle}>Final review — tap schedule to send invites.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Preview & schedule</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Final review — tap schedule to send invites. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleNewMeetingPreview • Page {page + 1}
        </Text>
      </View>
