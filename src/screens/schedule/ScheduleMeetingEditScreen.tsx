...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleMeetingEdit'>;
...
export default function ScheduleMeetingEditScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ScheduleInvite-0',
      label: "Manage invites",
      subtitle: "Add or remove attendees",
      icon: "people" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleInvite', { meetingId: params.meetingId as string }),
    },
    {
      key: 'ScheduleAgendaTemplate-1',
      label: "Apply agenda template",
      subtitle: "Start from a clean slate",
      icon: "reader" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleAgendaTemplate', { templateId: "t-0" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Edit meeting</Text>
        <Text style={styles.heroSubtitle}>Tweak title, time, agenda, attendees.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Edit meeting</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Tweak title, time, agenda, attendees. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleMeetingEdit • Page {page + 1}
        </Text>
      </View>
