...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleNewMeeting'>;
...
export default function ScheduleNewMeetingScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ScheduleNewMeetingDetails-0',
      label: "Title & description",
      subtitle: "Set the basic info",
      icon: "create" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleNewMeetingDetails', { date: params.date as string }),
    },
    {
      key: 'ScheduleNewMeetingRecurrence-1',
      label: "Recurrence",
      subtitle: "Daily, weekly, custom",
      icon: "repeat" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleNewMeetingRecurrence', { date: params.date as string }),
    },
    {
      key: 'ScheduleNewMeetingReminders-2',
      label: "Reminders",
      subtitle: "Push, email, calendar",
      icon: "alarm" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleNewMeetingReminders', { date: params.date as string }),
    },
    {
      key: 'ScheduleNewMeetingPreview-3',
      label: "Preview & schedule",
      subtitle: "Confirm and send invites",
      icon: "checkmark-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleNewMeetingPreview', { date: params.date as string }),
    },
  ];
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>SCHEDULE • LEVEL 2</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroSubtitle}>Tap through to fill in details, recurrence, reminders.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>New meeting</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Tap through to fill in details, recurrence, reminders. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleNewMeeting • Page {page + 1}
        </Text>
      </View>
