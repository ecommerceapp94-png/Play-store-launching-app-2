 ...
 *
 * Screen: ScheduleMeetingReschedule
 * Stack:  schedule
 * Depth:  Level 3
 */
...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleMeetingReschedule'>;
...
export default function ScheduleMeetingRescheduleScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Reschedule meeting</Text>
        <Text style={styles.heroSubtitle}>Pick a new date and notify attendees automatically.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Reschedule meeting</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Pick a new date and notify attendees automatically. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleMeetingReschedule • Page {page + 1}
        </Text>
      </View>
