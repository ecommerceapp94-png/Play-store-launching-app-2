...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleMeetingCancel'>;
...
export default function ScheduleMeetingCancelScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      subtitle: "Return without canceling",
      icon: "calendar" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleIndex'),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Cancel meeting</Text>
        <Text style={styles.heroSubtitle}>Confirm to send a polite cancellation note.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Cancel meeting</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Confirm to send a polite cancellation note. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleMeetingCancel • Page {page + 1}
        </Text>
      </View>
