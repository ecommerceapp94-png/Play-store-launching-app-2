...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleInvite'>;
...
export default function ScheduleInviteScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ScheduleInviteContact-0',
      label: "From contacts",
      subtitle: "Pick a person to invite",
      icon: "people" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleInviteContact', { meetingId: params.meetingId as string, contactId: "c-0" }),
    },
    {
      key: 'ScheduleInviteEmail-1',
      label: "Paste emails",
      subtitle: "Comma-separated list of emails",
      icon: "mail" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleInviteEmail', { meetingId: params.meetingId as string }),
    },
    {
      key: 'ScheduleInviteLink-2',
      label: "Public link",
      subtitle: "Anyone with the link can join",
      icon: "link" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleInviteLink', { meetingId: params.meetingId as string }),
    },
  ];
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>SCHEDULE • LEVEL 3</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Invite attendees</Text>
        <Text style={styles.heroSubtitle}>Add people from contacts, email, or generate a link.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Invite attendees</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Add people from contacts, email, or generate a link. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleInvite • Page {page + 1}
        </Text>
      </View>
