...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleInviteContact'>;
...
export default function ScheduleInviteContactScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Invite contact</Text>
        <Text style={styles.heroSubtitle}>Confirm the invite — you can add a personal note.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Invite contact</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Confirm the invite — you can add a personal note. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleInviteContact • Page {page + 1}
        </Text>
      </View>
