 ...
 *
 * Screen: ScheduleNewMeetingRecurrence
 * Stack:  schedule
 * Depth:  Level 3
 */
...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleNewMeetingRecurrence'>;
...
export default function ScheduleNewMeetingRecurrenceScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ScheduleNewMeetingPreview-0',
      label: "Skip to preview",
      subtitle: "You can edit later",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Recurrence</Text>
        <Text style={styles.heroSubtitle}>Repeating settings for weekly standups and more.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Recurrence</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Repeating settings for weekly standups and more. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleNewMeetingRecurrence • Page {page + 1}
        </Text>
      </View>
