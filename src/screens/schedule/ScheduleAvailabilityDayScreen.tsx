 ...
 *
 * Screen: ScheduleAvailabilityDay
 * Stack:  schedule
 * Depth:  Level 3
 */
...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleAvailabilityDay'>;
...
export default function ScheduleAvailabilityDayScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ScheduleAvailability-0',
      label: "Back to overview",
      subtitle: "See the whole week",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Availability for a day</Text>
        <Text style={styles.heroSubtitle}>Pick start, end, and break times.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Availability for a day</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Pick start, end, and break times. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleAvailabilityDay • Page {page + 1}
        </Text>
      </View>
