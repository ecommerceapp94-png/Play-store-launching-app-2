 ...
 *
 * Screen: ScheduleNewMeetingReminders
 * Stack:  schedule
 * Depth:  Level 3
 */
...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleNewMeetingReminders'>;
...
export default function ScheduleNewMeetingRemindersScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Choose which channels send reminders.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Reminders</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Choose which channels send reminders. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleNewMeetingReminders • Page {page + 1}
        </Text>
      </View>
