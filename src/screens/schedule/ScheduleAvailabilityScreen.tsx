...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleAvailability'>;
...
export default function ScheduleAvailabilityScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ScheduleAvailabilityDay-0',
      label: "Monday hours",
      subtitle: "Default 9:00 AM – 5:00 PM",
      icon: "time" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleAvailabilityDay', { day: "mon" }),
    },
    {
      key: 'ScheduleAvailabilityDay-1',
      label: "Tuesday hours",
      subtitle: "Default 9:00 AM – 5:00 PM",
      icon: "time" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleAvailabilityDay', { day: "tue" }),
    },
    {
      key: 'ScheduleAvailabilityDay-2',
      label: "Friday hours",
      subtitle: "Default 9:00 AM – 3:00 PM",
      icon: "time" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleAvailabilityDay', { day: "fri" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Set the times when others can book you.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>My availability</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Set the times when others can book you. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleAvailability • Page {page + 1}
        </Text>
      </View>
