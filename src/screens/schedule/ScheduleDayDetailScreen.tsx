...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleDayDetail'>;
...
export default function ScheduleDayDetailScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ScheduleMeetingEdit-0',
      label: "Edit first meeting",
      subtitle: "Change title, time, attendees",
      icon: "create" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleMeetingEdit', { meetingId: "m-0" }),
    },
    {
      key: 'ScheduleMeetingReschedule-1',
      label: "Reschedule",
      subtitle: "Move it to another day/time",
      icon: "swap-horizontal" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleMeetingReschedule', { meetingId: "m-0" }),
    },
    {
      key: 'ScheduleMeetingCancel-2',
      label: "Cancel meeting",
      subtitle: "Notify everyone",
      icon: "close-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleMeetingCancel', { meetingId: "m-0" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Every meeting on the selected day.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Daily schedule</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Every meeting on the selected day. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleDayDetail • Page {page + 1}
        </Text>
      </View>
