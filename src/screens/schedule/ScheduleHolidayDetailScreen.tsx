...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleHolidayDetail'>;
...
export default function ScheduleHolidayDetailScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      subtitle: "Return to the planner",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Holiday</Text>
        <Text style={styles.heroSubtitle}>Mark days you\'ll be unavailable for meetings.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Holiday</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Mark days you\'ll be unavailable for meetings. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleHolidayDetail • Page {page + 1}
        </Text>
      </View>
