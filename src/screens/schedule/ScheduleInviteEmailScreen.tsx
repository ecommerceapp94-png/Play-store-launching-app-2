...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleInviteEmail'>;
...
export default function ScheduleInviteEmailScreen() {
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>SCHEDULE • LEVEL 4</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Invite by email</Text>
        <Text style={styles.heroSubtitle}>Paste a list of email addresses to invite people quickly.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Invite by email</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Paste a list of email addresses to invite people quickly. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleInviteEmail • Page {page + 1}
        </Text>
      </View>
