...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleTimezoneDetail'>;
...
export default function ScheduleTimezoneDetailScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      label: "Adjust your hours",
      subtitle: "Match someone else's hours",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Time zone</Text>
        <Text style={styles.heroSubtitle}>See the time across teams in different cities.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Time zone</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>See the time across teams in different cities. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleTimezoneDetail • Page {page + 1}
        </Text>
      </View>
