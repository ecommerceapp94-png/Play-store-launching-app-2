...
type Route = RouteProp<ScheduleStackParamList, 'ScheduleIndex'>;
...
export default function ScheduleIndexScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ScheduleDayDetail-0',
      label: "Today",
      subtitle: "See today's schedule",
      icon: "sunny" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleDayDetail', { date: new Date().toISOString() }),
    },
    {
      key: 'ScheduleDayDetail-1',
      label: "Tomorrow",
      subtitle: "Plan ahead",
      icon: "sunny-outline" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleDayDetail', { date: new Date(Date.now() + 86400000).toISOString() }),
    },
    {
      key: 'ScheduleAvailability-2',
      label: "My availability",
      subtitle: "Set times you're free",
      icon: "time" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleAvailability'),
    },
    {
      key: 'ScheduleNewMeeting-3',
      label: "New meeting",
      subtitle: "Schedule from scratch",
      icon: "add-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ScheduleNewMeeting', { date: new Date().toISOString() }),
    },
  ];
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>SCHEDULE • LEVEL 1</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroSubtitle}>Calendar view, availability, holidays and more.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Schedule</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Calendar view, availability, holidays and more. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • schedule ScheduleIndex • Page {page + 1}
        </Text>
      </View>
