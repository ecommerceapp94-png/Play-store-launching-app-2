...
type Route = RouteProp<ProfileStackParamList, 'ProfileIndex'>;
...
export default function ProfileIndexScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    ...
    {
      key: 'ProfileRecordingsList-1',
      label: "Recordings folder",
      subtitle: "All your saved recordings",
      icon: "film" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileRecordingsList'),
    },
    {
      key: 'ProfileSettings-2',
      label: "Settings",
      subtitle: "Notifications, audio, video, storage",
      icon: "settings" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettings'),
    },
    {
      key: 'ProfileSecurity-3',
      label: "Security",
      subtitle: "Sign-in, devices, encryption",
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>PROFILE • LEVEL 1</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroSubtitle}>Personal info, recordings, and every preference.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Your profile</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Personal info, recordings, and every preference. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileIndex • Page {page + 1}
        </Text>
      </View>
