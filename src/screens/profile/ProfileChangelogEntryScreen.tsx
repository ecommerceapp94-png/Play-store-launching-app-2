...
type Route = RouteProp<ProfileStackParamList, 'ProfileChangelogEntry'>;
...
export default function ProfileChangelogEntryScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Changelog entry</Text>
        <Text style={styles.heroSubtitle}>Detailed notes for a specific release.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Changelog entry</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Detailed notes for a specific release. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileChangelogEntry • Page {page + 1}
        </Text>
      </View>
