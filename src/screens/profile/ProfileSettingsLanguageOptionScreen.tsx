 ...
 *
 * Screen: ProfileSettingsLanguageOption
 * Stack:  profile
 * Depth:  Level 4
 */
...
type Route = RouteProp<ProfileStackParamList, 'ProfileSettingsLanguageOption'>;
...
export default function ProfileSettingsLanguageOptionScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Language option</Text>
        <Text style={styles.heroSubtitle}>Set this as your active language.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Language option</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Set this as your active language. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSettingsLanguageOption • Page {page + 1}
        </Text>
      </View>
