 ...
 *
 * Screen: ProfileSettingsLanguage
 * Stack:  profile
 * Depth:  Level 3
 */
...
type Route = RouteProp<ProfileStackParamList, 'ProfileSettingsLanguage'>;
...
export default function ProfileSettingsLanguageScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileSettingsLanguageOption-0',
      label: "English (US)",
      subtitle: "Default with full feature support",
      icon: "globe" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsLanguageOption', { code: "en-US" }),
    },
    {
      key: 'ProfileSettingsLanguageOption-1',
      label: "Hindi",
      subtitle: "Beta — speech & captions",
      icon: "globe" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsLanguageOption', { code: "hi-IN" }),
    },
    {
      key: 'ProfileSettingsLanguageOption-2',
      label: "Japanese",
      subtitle: "Captions only",
      icon: "globe" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsLanguageOption', { code: "ja-JP" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>UI language and transcription dialects.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            ...
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>UI language and transcription dialects. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSettingsLanguage • Page {page + 1}
        </Text>
      </View>
