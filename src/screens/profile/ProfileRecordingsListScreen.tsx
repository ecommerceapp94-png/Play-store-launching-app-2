...
type Route = RouteProp<ProfileStackParamList, 'ProfileRecordingsList'>;
...
export default function ProfileRecordingsListScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileRecordingPlayback-0',
      label: "Open latest",
      subtitle: "Resume where you left off",
      icon: "play" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileRecordingPlayback', { recordingId: "r-0" }),
    },
    {
      key: 'ProfileRecordingShare-1',
      label: "Share latest",
      subtitle: "Send to a teammate",
      icon: "share-social" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileRecordingShare', { recordingId: "r-0" }),
    },
    {
      key: 'ProfileRecordingChapters-2',
      label: "See chapters",
      subtitle: "Jump straight to topics",
      icon: "list" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileRecordingChapters', { recordingId: "r-0" }),
    },
    {
      key: 'ProfileRecordingTranscript-3',
      label: "Open transcript",
      subtitle: "Searchable text",
      icon: "document-text" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileRecordingTranscript', { recordingId: "r-0" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Recordings</Text>
        <Text style={styles.heroSubtitle}>Open one to scrub, share, transcribe.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Recordings</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Open one to scrub, share, transcribe. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileRecordingsList • Page {page + 1}
        </Text>
      </View>
