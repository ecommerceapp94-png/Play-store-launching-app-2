 ...
 *
 * Screen: ProfileSettingsBackground
 * Stack:  profile
 * Depth:  Level 3
 */
...
type Route = RouteProp<ProfileStackParamList, 'ProfileSettingsBackground'>;
...
export default function ProfileSettingsBackgroundScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileSettingsBackgroundOption-0',
      label: "Studio lights",
      subtitle: "Bright, even, professional",
      icon: "sunny" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsBackgroundOption', { optionId: "studio-lights" }),
    },
    {
      key: 'ProfileSettingsBackgroundOption-1',
      label: "Beach getaway",
      subtitle: "Casual fun for office hours",
      icon: "sunny-outline" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsBackgroundOption', { optionId: "beach" }),
    },
    {
      key: 'ProfileSettingsBackgroundOption-2',
      label: "Bookshelf",
      subtitle: "Classic and warm",
      icon: "book" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsBackgroundOption', { optionId: "bookshelf" }),
    },
  ];
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>PROFILE • LEVEL 3</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Backgrounds</Text>
        <Text style={styles.heroSubtitle}>Virtual scenes and AI-generated rooms.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Backgrounds</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Virtual scenes and AI-generated rooms. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSettingsBackground • Page {page + 1}
        </Text>
      </View>
