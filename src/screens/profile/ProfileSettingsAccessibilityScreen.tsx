 ...
 *
 * Screen: ProfileSettingsAccessibility
 * Stack:  profile
 * Depth:  Level 3
 */
...
type Route = RouteProp<ProfileStackParamList, 'ProfileSettingsAccessibility'>;
...
export default function ProfileSettingsAccessibilityScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Captions, contrast, motion, screen reader.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Accessibility</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Captions, contrast, motion, screen reader. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSettingsAccessibility • Page {page + 1}
        </Text>
      </View>
