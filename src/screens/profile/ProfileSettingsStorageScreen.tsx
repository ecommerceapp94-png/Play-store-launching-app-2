...
type Route = RouteProp<ProfileStackParamList, 'ProfileSettingsStorage'>;
...
export default function ProfileSettingsStorageScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Cache size, auto-download, cellular usage.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Storage</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Cache size, auto-download, cellular usage. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSettingsStorage • Page {page + 1}
        </Text>
      </View>
