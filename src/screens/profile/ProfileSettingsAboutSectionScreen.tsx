 ...
 *
 * Screen: ProfileSettingsAboutSection
 * Stack:  profile
 * Depth:  Level 4
 */
...
type Route = RouteProp<ProfileStackParamList, 'ProfileSettingsAboutSection'>;
...
export default function ProfileSettingsAboutSectionScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileSettingsAbout-0',
      label: "Back to About",
      subtitle: "See other About sections",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>About section</Text>
        <Text style={styles.heroSubtitle}>Detailed copy for the selected section.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>About section</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Detailed copy for the selected section. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSettingsAboutSection • Page {page + 1}
        </Text>
      </View>
