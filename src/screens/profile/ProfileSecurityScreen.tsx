...
type Route = RouteProp<ProfileStackParamList, 'ProfileSecurity'>;
...
export default function ProfileSecurityScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileSecurityDetail-0',
      label: "Two-factor authentication",
      subtitle: "Authenticator, SMS, hardware key",
      icon: "key" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSecurityDetail', { topic: "2fa" }),
    },
    {
      key: 'ProfileSecurityDetail-1',
      label: "Active sessions",
      subtitle: "Devices currently signed in",
      icon: "desktop" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSecurityDetail', { topic: "sessions" }),
    },
    {
      key: 'ProfileSecurityDetail-2',
      label: "Privacy controls",
      subtitle: "Who can see what",
      icon: "lock-closed" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSecurityDetail', { topic: "privacy" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Sessions, two-factor, encryption keys.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Security</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Sessions, two-factor, encryption keys. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSecurity • Page {page + 1}
        </Text>
      </View>
