 ...
 *
 * Screen: ProfileSettingsNotifications
 * Stack:  profile
 * Depth:  Level 3
 */
...
type Route = RouteProp<ProfileStackParamList, 'ProfileSettingsNotifications'>;
...
export default function ProfileSettingsNotificationsScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Pick when MeetX nudges you.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            ...
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Pick when MeetX nudges you. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSettingsNotifications • Page {page + 1}
        </Text>
      </View>
