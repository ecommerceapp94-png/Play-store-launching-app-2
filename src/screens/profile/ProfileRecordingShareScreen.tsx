...
type Route = RouteProp<ProfileStackParamList, 'ProfileRecordingShare'>;
...
export default function ProfileRecordingShareScreen() {
  ...
  const items = state.recordings.slice(0, 12);
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileRecordingShareTarget-0',
      label: "Send to Slack",
      subtitle: "Pick a channel",
      icon: "logo-slack" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileRecordingShareTarget', { recordingId: params.recordingId as string, target: "slack" }),
    },
    {
      key: 'ProfileRecordingShareTarget-1',
      label: "Send to email",
      subtitle: "Compose a quick note",
      icon: "mail" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileRecordingShareTarget', { recordingId: params.recordingId as string, target: "email" }),
    },
    {
      key: 'ProfileRecordingShareTarget-2',
      label: "Public link",
      subtitle: "Anyone with the link",
      icon: "link" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileRecordingShareTarget', { recordingId: params.recordingId as string, target: "link" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Share recording</Text>
        <Text style={styles.heroSubtitle}>Pick where the recording should land.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Share recording</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Pick where the recording should land. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileRecordingShare • Page {page + 1}
        </Text>
      </View>
