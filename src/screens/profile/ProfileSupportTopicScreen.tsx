...
type Route = RouteProp<ProfileStackParamList, 'ProfileSupportTopic'>;
...
export default function ProfileSupportTopicScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileSupportThread-0',
      label: "Open thread",
      subtitle: "Talk to support",
      icon: "chatbubbles" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSupportThread', { id: params.id as string, threadId: "t-0" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Support topic</Text>
        <Text style={styles.heroSubtitle}>Common questions and step-by-step guides.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Support topic</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Common questions and step-by-step guides. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSupportTopic • Page {page + 1}
        </Text>
      </View>
