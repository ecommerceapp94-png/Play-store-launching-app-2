 ...
 *
 * Screen: ProfileSettingsBackgroundOption
 * Stack:  profile
 * Depth:  Level 4
 */
...
type Route = RouteProp<ProfileStackParamList, 'ProfileSettingsBackgroundOption'>;
...
export default function ProfileSettingsBackgroundOptionScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileSettingsBackground-0',
      label: "Back to all backgrounds",
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>PROFILE • LEVEL 4</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Background option</Text>
        <Text style={styles.heroSubtitle}>Apply this background and adjust intensity.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Background option</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Apply this background and adjust intensity. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSettingsBackgroundOption • Page {page + 1}
        </Text>
      </View>
