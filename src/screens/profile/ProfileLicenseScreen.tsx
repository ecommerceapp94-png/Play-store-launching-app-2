...
type Route = RouteProp<ProfileStackParamList, 'ProfileLicense'>;
...
export default function ProfileLicenseScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>License</Text>
        <Text style={styles.heroSubtitle}>A specific open-source license used by MeetX.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>License</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>A specific open-source license used by MeetX. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileLicense • Page {page + 1}
        </Text>
      </View>
