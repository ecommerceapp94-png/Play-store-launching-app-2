...
type Route = RouteProp<ProfileStackParamList, 'ProfileSettings'>;
...
export default function ProfileSettingsScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileSettingsNotifications-0',
      label: "Notifications",
      subtitle: "Email, push, in-app",
      icon: "notifications" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsNotifications'),
    },
    {
      key: 'ProfileSettingsAudio-1',
      label: "Audio",
      subtitle: "Mic, noise suppression, echo",
      icon: "mic" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsAudio'),
    },
    {
      key: 'ProfileSettingsVideo-2',
      label: "Video",
      subtitle: "Camera, quality, lighting",
      icon: "videocam" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsVideo'),
    },
    {
      key: 'ProfileSettingsBackground-3',
      label: "Backgrounds",
      subtitle: "Virtual + AI generated",
      icon: "image" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsBackground'),
    },
    {
      key: 'ProfileSettingsLanguage-4',
      label: "Language",
      subtitle: "UI + transcription",
      icon: "language" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsLanguage'),
    },
    {
      key: 'ProfileSettingsStorage-5',
      label: "Storage",
      subtitle: "Cache, downloads",
      icon: "cloud" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsStorage'),
    },
    {
      key: 'ProfileSettingsAccessibility-6',
      label: "Accessibility",
      subtitle: "Captions, contrast, motion",
      icon: "accessibility" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsAccessibility'),
    },
    {
      key: 'ProfileSettingsAbout-7',
      label: "About",
      subtitle: "Version, licenses, changelog",
      icon: "information-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsAbout'),
    },
  ];

  const heroGradient = theme.colors.createGradient;
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>PROFILE • LEVEL 2</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroSubtitle}>Notifications, audio, video, language, storage.</Text>
        ...
        <View style={styles.heroStatsRow}>
          ...
          <View style={styles.heroStat}>
            <Text style={styles.heroStatValue}>2/4</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Settings</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Notifications, audio, video, language, storage. Tap any tile below to keep diving.</Text>
      ...
      {loading ? (
        ...
        <View style={{ paddingHorizontal: 16 }}>
          <EmptyState title="Nothing here yet" body="When data lands it will show up automatically." ctaLabel="Refresh" onCta={() => onRefresh()} />
        </View>
      )}
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSettings • Page {page + 1}
        </Text>
      </View>
