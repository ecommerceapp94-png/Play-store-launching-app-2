...
type Route = RouteProp<ProfileStackParamList, 'ProfileSettingsVideo'>;
...
export default function ProfileSettingsVideoScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Camera, resolution, framing.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Video</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Camera, resolution, framing. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSettingsVideo • Page {page + 1}
        </Text>
      </View>
