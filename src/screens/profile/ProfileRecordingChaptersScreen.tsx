 ...
 *
 * Screen: ProfileRecordingChapters
 * Stack:  profile
 * Depth:  Level 3
 */
...
type Route = RouteProp<ProfileStackParamList, 'ProfileRecordingChapters'>;
...
export default function ProfileRecordingChaptersScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileRecordingChapter-0',
      label: "Chapter 1",
      subtitle: "Opening remarks",
      icon: "play-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileRecordingChapter', { recordingId: params.recordingId as string, chapterId: "ch-0" }),
    },
    {
      key: 'ProfileRecordingChapter-1',
      label: "Chapter 2",
      subtitle: "Customer feedback",
      icon: "play-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileRecordingChapter', { recordingId: params.recordingId as string, chapterId: "ch-1" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>AI-generated chapters for the selected recording.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Chapters</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>AI-generated chapters for the selected recording. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileRecordingChapters • Page {page + 1}
        </Text>
      </View>
