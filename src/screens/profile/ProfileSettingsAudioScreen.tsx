...
type Route = RouteProp<ProfileStackParamList, 'ProfileSettingsAudio'>;
...
export default function ProfileSettingsAudioScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileSettings-0',
      label: "Back to settings",
      subtitle: "See other options",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Audio</Text>
        <Text style={styles.heroSubtitle}>Microphone, noise suppression, echo cancellation.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Audio</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Microphone, noise suppression, echo cancellation. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSettingsAudio • Page {page + 1}
        </Text>
      </View>
