...
type Route = RouteProp<ProfileStackParamList, 'ProfileSupportThread'>;
...
export default function ProfileSupportThreadScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileSupportTopic-0',
      label: "Back to topic",
      subtitle: "See related FAQs",
      icon: "arrow-back" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSupportTopic', { id: params.id as string }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Support thread</Text>
        <Text style={styles.heroSubtitle}>Conversation with the support team.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Support thread</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Conversation with the support team. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSupportThread • Page {page + 1}
        </Text>
      </View>
