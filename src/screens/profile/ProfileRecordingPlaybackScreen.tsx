 ...
 *
 * Screen: ProfileRecordingPlayback
 * Stack:  profile
 * Depth:  Level 3
 */
...
type Route = RouteProp<ProfileStackParamList, 'ProfileRecordingPlayback'>;
...
export default function ProfileRecordingPlaybackScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileRecordingShare-0',
      label: "Share",
      subtitle: "Pick a destination",
      icon: "share-social" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileRecordingShare', { recordingId: params.recordingId as string }),
    },
    {
      key: 'ProfileRecordingChapters-1',
      label: "Chapters",
      subtitle: "Jump to a chapter",
      icon: "list" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileRecordingChapters', { recordingId: params.recordingId as string }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Playback</Text>
        <Text style={styles.heroSubtitle}>Premium scrubber with chapter markers.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Playback</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Premium scrubber with chapter markers. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileRecordingPlayback • Page {page + 1}
        </Text>
      </View>
