...
type Route = RouteProp<ProfileStackParamList, 'ProfileEdit'>;
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      label: "Open settings",
      subtitle: "Tweak app preferences",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Update your details and tap save.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Edit profile</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Update your details and tap save. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileEdit • Page {page + 1}
        </Text>
      </View>
