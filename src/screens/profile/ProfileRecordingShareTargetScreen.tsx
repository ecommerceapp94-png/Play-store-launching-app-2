 ...
 *
 * Screen: ProfileRecordingShareTarget
 * Stack:  profile
 * Depth:  Level 4
 */
...
type Route = RouteProp<ProfileStackParamList, 'ProfileRecordingShareTarget'>;
...
export default function ProfileRecordingShareTargetScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      label: "Back",
      subtitle: "See other share options",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Share target</Text>
        <Text style={styles.heroSubtitle}>Confirm and send.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Share target</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Confirm and send. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileRecordingShareTarget • Page {page + 1}
        </Text>
      </View>
