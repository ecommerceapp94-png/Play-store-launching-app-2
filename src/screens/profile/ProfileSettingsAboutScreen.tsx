...
type Route = RouteProp<ProfileStackParamList, 'ProfileSettingsAbout'>;
...
export default function ProfileSettingsAboutScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileSettingsAboutSection-0',
      label: "Licenses",
      subtitle: "Open-source acknowledgements",
      icon: "document-text" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsAboutSection', { section: "licenses" }),
    },
    {
      key: 'ProfileSettingsAboutSection-1',
      label: "Changelog",
      subtitle: "Every recent ship",
      icon: "newspaper" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsAboutSection', { section: "changelog" }),
    },
    {
      key: 'ProfileSettingsAboutSection-2',
      label: "Credits",
      subtitle: "The team behind MeetX",
      icon: "people" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileSettingsAboutSection', { section: "credits" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Version, licenses, changelog.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            ...
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Version, licenses, changelog. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSettingsAbout • Page {page + 1}
        </Text>
      </View>
