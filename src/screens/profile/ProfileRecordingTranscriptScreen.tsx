 ...
 *
 * Screen: ProfileRecordingTranscript
 * Stack:  profile
 * Depth:  Level 3
 */
...
type Route = RouteProp<ProfileStackParamList, 'ProfileRecordingTranscript'>;
...
export default function ProfileRecordingTranscriptScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileRecordingTranscriptSegment-0',
      label: "Open segment",
      subtitle: "Speaker, sentiment, jump-to",
      icon: "play-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileRecordingTranscriptSegment', { recordingId: params.recordingId as string, segmentId: "s-0" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Transcript</Text>
        <Text style={styles.heroSubtitle}>Search, highlight, jump to time.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Transcript</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Search, highlight, jump to time. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileRecordingTranscript • Page {page + 1}
        </Text>
      </View>
