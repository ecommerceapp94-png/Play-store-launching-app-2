 ...
 *
 * Screen: ProfileRecordingChapter
 * Stack:  profile
 * Depth:  Level 4
 */
...
type Route = RouteProp<ProfileStackParamList, 'ProfileRecordingChapter'>;
...
export default function ProfileRecordingChapterScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileRecordingChapters-0',
      label: "Back to chapters",
      subtitle: "See full chapter list",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Title, summary, jump-to-time.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Chapter</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Title, summary, jump-to-time. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileRecordingChapter • Page {page + 1}
        </Text>
      </View>
