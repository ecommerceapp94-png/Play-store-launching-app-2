 ...
 *
 * Screen: ProfileRecordingTranscriptSegment
 * Stack:  profile
 * Depth:  Level 4
 */
...
type Route = RouteProp<ProfileStackParamList, 'ProfileRecordingTranscriptSegment'>;
...
export default function ProfileRecordingTranscriptSegmentScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileRecordingTranscript-0',
      label: "Back to transcript",
      subtitle: "Read the rest",
      icon: "arrow-back" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ProfileRecordingTranscript', { recordingId: params.recordingId as string }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Transcript segment</Text>
        <Text style={styles.heroSubtitle}>A single block of speaker dialog.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Transcript segment</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>A single block of speaker dialog. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileRecordingTranscriptSegment • Page {page + 1}
        </Text>
      </View>
