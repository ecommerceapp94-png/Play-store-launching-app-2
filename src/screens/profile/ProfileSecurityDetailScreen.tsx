...
type Route = RouteProp<ProfileStackParamList, 'ProfileSecurityDetail'>;
...
export default function ProfileSecurityDetailScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ProfileSecurity-0',
      label: "Back to security",
      subtitle: "View other topics",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Security topic</Text>
        <Text style={styles.heroSubtitle}>Detailed control over a specific privacy area.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Security topic</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Detailed control over a specific privacy area. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • profile ProfileSecurityDetail • Page {page + 1}
        </Text>
      </View>
