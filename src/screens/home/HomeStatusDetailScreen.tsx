...
type Route = RouteProp<HomeStackParamList, 'HomeStatusDetail'>;
...
export default function HomeStatusDetailScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      label: "Tweak defaults",
      subtitle: "Switch to data-saver and more",
      icon: "settings" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeAdvancedSettings', { code: "status" }),
    },
    {
      key: 'HomeFeatureSpotlight-1',
      label: "AI insights",
      subtitle: "Find patterns automatically",
      icon: "analytics" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeFeatureSpotlight', { feature: "ai-insights" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Status report</Text>
        <Text style={styles.heroSubtitle}>Real-time meeting health for your account.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Status report</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Real-time meeting health for your account. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeStatusDetail • Page {page + 1}
        </Text>
      </View>
