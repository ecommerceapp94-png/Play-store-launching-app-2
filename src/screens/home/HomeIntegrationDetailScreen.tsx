...
type Route = RouteProp<HomeStackParamList, 'HomeIntegrationDetail'>;
...
export default function HomeIntegrationDetailScreen() {
  ...
  const items = state.integrations.slice(0, 10);
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      subtitle: "A pre-built recipe to start with",
      icon: "flowchart" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeFeatureSpotlight', { feature: "workflow" }),
    },
    {
      key: 'HomeAnnouncementDetail-1',
      label: "Read launch post",
      subtitle: "Why we built this integration",
      icon: "megaphone" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeAnnouncementDetail', { id: "launch-post" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Integration details</Text>
        <Text style={styles.heroSubtitle}>Set up the integration and see what it can automate.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Integration details</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Set up the integration and see what it can automate. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeIntegrationDetail • Page {page + 1}
        </Text>
      </View>
