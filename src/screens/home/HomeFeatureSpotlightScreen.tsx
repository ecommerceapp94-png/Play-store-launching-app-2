...
type Route = RouteProp<HomeStackParamList, 'HomeFeatureSpotlight'>;
...
export default function HomeFeatureSpotlightScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'HomeIntegrationDetail-0',
      label: "Use with integrations",
      subtitle: "Workflows and triggers",
      icon: "extension-puzzle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeIntegrationDetail', { integrationId: "linear" }),
    },
    {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Feature spotlight</Text>
        <Text style={styles.heroSubtitle}>Everything you need to know about this feature.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Feature spotlight</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Everything you need to know about this feature. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeFeatureSpotlight • Page {page + 1}
        </Text>
      </View>
