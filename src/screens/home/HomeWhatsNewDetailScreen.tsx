...
type Route = RouteProp<HomeStackParamList, 'HomeWhatsNewDetail'>;
...
export default function HomeWhatsNewDetailScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'HomeAnnouncementDetail-0',
      label: "Read full announcement",
      subtitle: "A deeper dive into the release",
      icon: "document" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeAnnouncementDetail', { id: "ann-0" }),
    },
    {
      key: 'HomeFeatureSpotlight-1',
      label: "See the demo",
      subtitle: "Watch the feature in action",
      icon: "play" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeFeatureSpotlight', { feature: "ai" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Latest releases, polish, and bug fixes.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>What\'s new</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Latest releases, polish, and bug fixes. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeWhatsNewDetail • Page {page + 1}
        </Text>
      </View>
