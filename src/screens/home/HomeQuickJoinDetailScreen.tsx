...
type Route = RouteProp<HomeStackParamList, 'HomeQuickJoinDetail'>;
...
export default function HomeQuickJoinDetailScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'HomeMeetingControlsPreview-0',
      label: "Open camera preview",
      subtitle: "See yourself before joining",
      icon: "videocam" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeMeetingControlsPreview', { code: "qr" }),
    },
    {
      key: 'HomeAdvancedSettings-1',
      label: "Advanced options",
      subtitle: "Network, captions, persona",
      icon: "cog" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeAdvancedSettings', { code: "qr" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Quick join details</Text>
        <Text style={styles.heroSubtitle}>Confirm the room, your defaults, and tap join.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Quick join details</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Confirm the room, your defaults, and tap join. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeQuickJoinDetail • Page {page + 1}
        </Text>
      </View>
