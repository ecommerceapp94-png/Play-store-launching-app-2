...
type Route = RouteProp<HomeStackParamList, 'HomeCreateFlow'>;
...
export default function HomeCreateFlowScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'HomeCreateOptions-0',
      label: "Instant meeting",
      subtitle: "Start now and invite people in-call",
      icon: "flash" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeCreateOptions'),
    },
    {
      key: 'HomeCreateOptions-1',
      label: "Schedule for later",
      subtitle: "Pick a time and we email everyone",
      icon: "time" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeCreateOptions'),
    },
    {
      key: 'HomeCreateOptions-2',
      label: "Webinar mode",
      subtitle: "Up to 10,000 attendees",
      icon: "megaphone" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeCreateOptions'),
    },
    {
      key: 'HomeCreateOptions-3',
      label: "Office hours",
      subtitle: "Open up your calendar to teammates",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Create a new meeting</Text>
        <Text style={styles.heroSubtitle}>Pick the right format and let MeetX handle the rest.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Create a new meeting</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Pick the right format and let MeetX handle the rest. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeCreateFlow • Page {page + 1}
        </Text>
      </View>
