 ...
 *
 * Screen: HomeMeetingControlsPreview
 * Stack:  home
 * Depth:  Level 3
 */
...
type Route = RouteProp<HomeStackParamList, 'HomeMeetingControlsPreview'>;
...
export default function HomeMeetingControlsPreviewScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'HomeAdvancedSettings-0',
      label: "Audio & video advanced",
      subtitle: "Tweak mic gain, camera, virtual backgrounds",
      icon: "settings" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeAdvancedSettings', { code: "advanced" }),
    },
    {
      key: 'HomeQuickJoinDetail-1',
      label: "Switch persona",
      subtitle: "Pick the avatar and name people will see",
      icon: "happy" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeQuickJoinDetail', { code: "persona" }),
    },
    {
      key: 'HomeFeatureSpotlight-2',
      label: "AI noise removal",
      subtitle: "Quiet that noisy cafe",
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>HOME • LEVEL 3</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Set up your join</Text>
        <Text style={styles.heroSubtitle}>Preview your camera, mic and persona before tapping join.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Set up your join</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Preview your camera, mic and persona before tapping join. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeMeetingControlsPreview • Page {page + 1}
        </Text>
      </View>
