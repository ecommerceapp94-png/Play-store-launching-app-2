...
type Route = RouteProp<HomeStackParamList, 'HomeJoinFlow'>;
...
export default function HomeJoinFlowScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'HomeJoinKeypad-0',
      label: "Enter a room code",
      subtitle: "Type the 9-digit code",
      icon: "keypad" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeJoinKeypad'),
    },
    {
      key: 'HomeQuickJoinDetail-1',
      label: "Paste an invite link",
      subtitle: "We auto-detect MeetX URLs",
      icon: "link" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeQuickJoinDetail', { code: "paste-link" }),
    },
    {
      key: 'HomeQuickJoinDetail-2',
      label: "Scan a QR code",
      subtitle: "Use your camera to scan",
      icon: "qr-code" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeQuickJoinDetail', { code: "qr-scan" }),
    },
    {
      key: 'HomeMeetingControlsPreview-3',
      label: "Browse my favorite rooms",
      subtitle: "Saved rooms ready to go",
      icon: "star" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeMeetingControlsPreview', { code: "favorites" }),
    },
  ];

  const heroGradient = theme.colors.joinGradient;
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>HOME • LEVEL 2</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Join an existing meeting</Text>
        <Text style={styles.heroSubtitle}>Choose how you want to land in the room — code, link, or QR.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Join an existing meeting</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Choose how you want to land in the room — code, link, or QR. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeJoinFlow • Page {page + 1}
        </Text>
      </View>
