...
type Route = RouteProp<HomeStackParamList, 'HomeTipDetail'>;
...
export default function HomeTipDetailScreen() {
  ...
  const items = state.tips.slice(0, 8);
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      onPress: () => navigation.navigate('HomeFeatureSpotlight', { feature: "tip" }),
    },
    {
      key: 'HomeIntegrationDetail-1',
      label: "Pair with Slack",
      subtitle: "Share notes automatically",
      icon: "logo-slack" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeIntegrationDetail', { integrationId: "slack" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Pro tip</Text>
        <Text style={styles.heroSubtitle}>Quick tricks that experienced MeetX users love.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Pro tip</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Quick tricks that experienced MeetX users love. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeTipDetail • Page {page + 1}
        </Text>
      </View>
