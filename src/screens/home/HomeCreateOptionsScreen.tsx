...
type Route = RouteProp<HomeStackParamList, 'HomeCreateOptions'>;
...
export default function HomeCreateOptionsScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'HomeCreateInvite-0',
      label: "Invite participants",
      subtitle: "From contacts, email, or a public link",
      icon: "people" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeCreateInvite', { meetingId: "m-0" }),
    },
    {
      key: 'HomeCreateScheduling-1',
      label: "Schedule details",
      subtitle: "Recurrence, time zones, reminders",
      icon: "calendar" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeCreateScheduling', { meetingId: "m-0" }),
    },
    {
      key: 'HomeAdvancedSettings-2',
      label: "Defaults for this room",
      subtitle: "Mic, camera, recording behavior",
      icon: "settings" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeAdvancedSettings', { code: "create-defaults" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Tune your new meeting</Text>
        <Text style={styles.heroSubtitle}>Lock down access, pick reminders, set defaults.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Tune your new meeting</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Lock down access, pick reminders, set defaults. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeCreateOptions • Page {page + 1}
        </Text>
      </View>
