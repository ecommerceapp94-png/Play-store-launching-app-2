...
type Route = RouteProp<HomeStackParamList, 'HomeCreateInvite'>;
...
export default function HomeCreateInviteScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'HomeCreateScheduling-0',
      label: "Continue to schedule",
      subtitle: "You can keep editing later",
      icon: "calendar" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeCreateScheduling', { meetingId: "m-0" }),
    },
    {
      key: 'HomeQuickJoinDetail-1',
      label: "Send invites via email",
      subtitle: "We compose a friendly note",
      icon: "mail" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeQuickJoinDetail', { code: "invite-email" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Invite people</Text>
        <Text style={styles.heroSubtitle}>Pick contacts, paste emails, or share a public link.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Invite people</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Pick contacts, paste emails, or share a public link. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeCreateInvite • Page {page + 1}
        </Text>
      </View>
