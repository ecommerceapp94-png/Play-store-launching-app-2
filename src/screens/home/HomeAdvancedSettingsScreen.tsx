...
type Route = RouteProp<HomeStackParamList, 'HomeAdvancedSettings'>;
...
export default function HomeAdvancedSettingsScreen() {
  ...
  const items = state.recentRooms.slice(0, 12);
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      subtitle: "12 polished looks",
      icon: "color-filter" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeFeatureSpotlight', { feature: "filters" }),
    },
    {
      key: 'HomeFeatureSpotlight-1',
      label: "Virtual backgrounds",
      subtitle: "Studio, beach, neutral and more",
      icon: "image" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeFeatureSpotlight', { feature: "backgrounds" }),
    },
    {
      key: 'HomeFeatureSpotlight-2',
      label: "Studio lighting",
      subtitle: "Even out tricky lighting",
      icon: "flashlight" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeFeatureSpotlight', { feature: "lighting" }),
    },
    {
      key: 'HomeFeatureSpotlight-3',
      label: "Noise suppression",
      subtitle: "AI-trained on 1.2M hours of meeting audio",
      icon: "mic-off" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeFeatureSpotlight', { feature: "noise" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Advanced join settings</Text>
        <Text style={styles.heroSubtitle}>Fine-tune every aspect of your call before you walk in.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Advanced join settings</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Fine-tune every aspect of your call before you walk in. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeAdvancedSettings • Page {page + 1}
        </Text>
      </View>
