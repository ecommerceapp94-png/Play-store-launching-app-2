...
type Route = RouteProp<HomeStackParamList, 'HomeFavoriteRoom'>;
...
export default function HomeFavoriteRoomScreen() {
  ...
  const items = state.favorites.slice(0, 12);
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'HomeQuickJoinDetail-0',
      label: "Quick join",
      subtitle: "Skip the lobby and walk right in",
      icon: "flash" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeQuickJoinDetail', { code: "quick" }),
    },
    {
      key: 'HomeAdvancedSettings-1',
      label: "Edit presets",
      subtitle: "Update mic, camera and recording defaults",
      icon: "create" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeAdvancedSettings', { code: "edit" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Favorite room</Text>
        <Text style={styles.heroSubtitle}>A pinned room with a custom shortcut and presets.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Favorite room</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>A pinned room with a custom shortcut and presets. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeFavoriteRoom • Page {page + 1}
        </Text>
      </View>
