...
type Route = RouteProp<HomeStackParamList, 'HomeRecentRoom'>;
...
export default function HomeRecentRoomScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      label: "Join now",
      subtitle: "Open this room with current defaults",
      icon: "enter" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeQuickJoinDetail', { code: "rejoin" }),
    },
    {
      key: 'HomeFavoriteRoom-1',
      label: "Save to favorites",
      subtitle: "Pin for one-tap join",
      icon: "star" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeFavoriteRoom', { roomId: "rec" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Recent room</Text>
        <Text style={styles.heroSubtitle}>Re-enter a room you have used before.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Recent room</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Re-enter a room you have used before. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeRecentRoom • Page {page + 1}
        </Text>
      </View>
