...
type Route = RouteProp<HomeStackParamList, 'HomePromoDetail'>;
...
export default function HomePromoDetailScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      onPress: () => navigation.navigate('HomeIntegrationDetail', { integrationId: "bundle" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Promotion</Text>
        <Text style={styles.heroSubtitle}>Grab the deal before it expires.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Promotion</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Grab the deal before it expires. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomePromoDetail • Page {page + 1}
        </Text>
      </View>
