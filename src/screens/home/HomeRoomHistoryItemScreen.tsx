...
type Route = RouteProp<HomeStackParamList, 'HomeRoomHistoryItem'>;
...
export default function HomeRoomHistoryItemScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      label: "Rejoin",
      subtitle: "Open the same room again",
    ...
    },
    {
      ...
      subtitle: "Pin for one-tap access",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Room history entry</Text>
        <Text style={styles.heroSubtitle}>Replay or rejoin a room with full context.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Room history entry</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Replay or rejoin a room with full context. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeRoomHistoryItem • Page {page + 1}
        </Text>
      </View>
