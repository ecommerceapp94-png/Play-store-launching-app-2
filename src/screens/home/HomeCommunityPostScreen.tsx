...
type Route = RouteProp<HomeStackParamList, 'HomeCommunityPost'>;
...
export default function HomeCommunityPostScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      label: "Reply",
      subtitle: "Open thread to respond",
      icon: "chatbubble" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeAnnouncementDetail', { id: "reply" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Community post</Text>
        <Text style={styles.heroSubtitle}>See what users are sharing about MeetX.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Community post</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>See what users are sharing about MeetX. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeCommunityPost • Page {page + 1}
        </Text>
      </View>
