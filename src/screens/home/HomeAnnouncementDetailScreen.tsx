...
type Route = RouteProp<HomeStackParamList, 'HomeAnnouncementDetail'>;
...
export default function HomeAnnouncementDetailScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      label: "See the new feature",
      subtitle: "Live demo & FAQ",
      icon: "sparkles" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeFeatureSpotlight', { feature: "ai-noise" }),
    },
    {
      key: 'HomeWhatsNewDetail-1',
      label: "Browse changelog",
      subtitle: "Every recent ship in one place",
      icon: "reader" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('HomeWhatsNewDetail', { id: "changelog" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Announcement</Text>
        <Text style={styles.heroSubtitle}>Read the full release note and discover related screens.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Announcement</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Read the full release note and discover related screens. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • home HomeAnnouncementDetail • Page {page + 1}
        </Text>
      </View>
