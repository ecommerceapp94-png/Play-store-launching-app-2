...
type Route = RouteProp<RootStackParamList, 'InCallSettings2'>;
...
export default function InCallSettings2Screen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'InCallSettings3-0',
      label: "Section A",
      subtitle: "Detailed controls",
      icon: "layers" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings3', { category: params.category as string, section: "A" }),
    },
    {
      key: 'InCallSettings3-1',
      label: "Section B",
      subtitle: "Detailed controls",
      icon: "layers" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings3', { category: params.category as string, section: "B" }),
    },
    {
      key: 'InCallSettings3-2',
      label: "Section C",
      subtitle: "Detailed controls",
      icon: "layers" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings3', { category: params.category as string, section: "C" }),
    },
  ];
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>INCALL • LEVEL 2</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroSubtitle}>Choose a section in this category.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Category</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Choose a section in this category. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • incall InCallSettings2 • Page {page + 1}
        </Text>
      </View>
