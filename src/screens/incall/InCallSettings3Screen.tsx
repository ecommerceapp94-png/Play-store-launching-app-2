...
type Route = RouteProp<RootStackParamList, 'InCallSettings3'>;
...
export default function InCallSettings3Screen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'InCallSettings4-0',
      label: "Option 1",
      subtitle: "Open detailed controls",
      icon: "options" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings4', { category: params.category as string, section: params.section as string, option: "1" }),
    },
    {
      key: 'InCallSettings4-1',
      label: "Option 2",
      subtitle: "Open detailed controls",
      icon: "options" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings4', { category: params.category as string, section: params.section as string, option: "2" }),
    },
    {
      key: 'InCallSettings4-2',
      label: "Option 3",
      subtitle: "Open detailed controls",
      icon: "options" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings4', { category: params.category as string, section: params.section as string, option: "3" }),
    },
  ];
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>INCALL • LEVEL 3</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroSubtitle}>Pick an option to fine-tune.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Section</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Pick an option to fine-tune. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • incall InCallSettings3 • Page {page + 1}
        </Text>
      </View>
