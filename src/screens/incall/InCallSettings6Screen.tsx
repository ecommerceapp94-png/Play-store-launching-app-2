...
type Route = RouteProp<RootStackParamList, 'InCallSettings6'>;
...
export default function InCallSettings6Screen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'InCallSettings1-0',
      label: "Back to top of in-call settings",
      subtitle: "See all categories again",
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>INCALL • LEVEL 6</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Deep tweak</Text>
        <Text style={styles.heroSubtitle}>The deepest setting — adjust and tap save.</Text>
        ...
        <View style={styles.heroStatsRow}>
          ...
          <View style={styles.heroStat}>
            <Text style={styles.heroStatValue}>6/4</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Deep tweak</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>The deepest setting — adjust and tap save. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • incall InCallSettings6 • Page {page + 1}
        </Text>
      </View>
