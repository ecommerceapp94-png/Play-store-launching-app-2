...
type Route = RouteProp<RootStackParamList, 'InCallSettings1'>;
...
export default function InCallSettings1Screen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'InCallSettings2-0',
      label: "Video",
      subtitle: "Resolution, framing, lighting",
      icon: "videocam" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings2', { category: "video" }),
    },
    {
      key: 'InCallSettings2-1',
      label: "Audio",
      subtitle: "Microphone, noise suppression",
      icon: "mic" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings2', { category: "audio" }),
    },
    {
      key: 'InCallSettings2-2',
      label: "Filters",
      subtitle: "Beauty, color presets",
      icon: "color-filter" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings2', { category: "filters" }),
    },
    {
      key: 'InCallSettings2-3',
      label: "Backgrounds",
      subtitle: "Virtual + AI generated",
      icon: "image" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings2', { category: "backgrounds" }),
    },
    {
      key: 'InCallSettings2-4',
      label: "Recording",
      subtitle: "Cloud or local, retention",
      icon: "recording" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings2', { category: "recording" }),
    },
    {
      key: 'InCallSettings2-5',
      label: "Captions",
      subtitle: "Real-time subtitles & translations",
      icon: "text" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings2', { category: "captions" }),
    },
  ];

  const heroGradient = theme.colors.premiumGradient;
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>INCALL • LEVEL 1</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>In-call settings</Text>
        <Text style={styles.heroSubtitle}>Choose a category to dive deeper.</Text>
        ...
        <View style={styles.heroStatsRow}>
          ...
          <View style={styles.heroStat}>
            <Text style={styles.heroStatValue}>1/4</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>In-call settings</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Choose a category to dive deeper. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • incall InCallSettings1 • Page {page + 1}
        </Text>
      </View>
