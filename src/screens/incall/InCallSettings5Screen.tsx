...
type Route = RouteProp<RootStackParamList, 'InCallSettings5'>;
...
export default function InCallSettings5Screen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'InCallSettings6-0',
      label: "Deep tweak A",
      subtitle: "Final layer",
      icon: "options" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings6', { category: params.category as string, section: params.section as string, option: params.option as string, sub: params.sub as string, deep: "A" }),
    },
    {
      key: 'InCallSettings6-1',
      label: "Deep tweak B",
      subtitle: "Final layer",
      icon: "options" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings6', { category: params.category as string, section: params.section as string, option: params.option as string, sub: params.sub as string, deep: "B" }),
    },
  ];
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>INCALL • LEVEL 5</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Sub-option</Text>
        <Text style={styles.heroSubtitle}>One more level of nesting.</Text>
        ...
        <View style={styles.heroStatsRow}>
          ...
          <View style={styles.heroStat}>
            <Text style={styles.heroStatValue}>5/4</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Sub-option</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>One more level of nesting. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • incall InCallSettings5 • Page {page + 1}
        </Text>
      </View>
