...
type Route = RouteProp<RootStackParamList, 'InCallSettings4'>;
...
export default function InCallSettings4Screen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'InCallSettings5-0',
      label: "Sub-option A",
      subtitle: "Drill in further",
      icon: "list" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings5', { category: params.category as string, section: params.section as string, option: params.option as string, sub: "A" }),
    },
    {
      key: 'InCallSettings5-1',
      label: "Sub-option B",
      subtitle: "Drill in further",
      icon: "list" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('InCallSettings5', { category: params.category as string, section: params.section as string, option: params.option as string, sub: "B" }),
    },
  ];
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>INCALL • LEVEL 4</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Option</Text>
        <Text style={styles.heroSubtitle}>Pick a sub-option for fine-grained control.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Option</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Pick a sub-option for fine-grained control. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • incall InCallSettings4 • Page {page + 1}
        </Text>
      </View>
