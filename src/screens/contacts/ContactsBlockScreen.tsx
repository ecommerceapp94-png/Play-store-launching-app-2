...
type Route = RouteProp<ContactsStackParamList, 'ContactsBlock'>;
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      subtitle: "Cancel and return",
      icon: "arrow-back" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsProfile', { contactId: params.contactId as string }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Block contact</Text>
        <Text style={styles.heroSubtitle}>Confirm to block calls and messages from this person.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Block contact</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Confirm to block calls and messages from this person. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsBlock • Page {page + 1}
        </Text>
      </View>
