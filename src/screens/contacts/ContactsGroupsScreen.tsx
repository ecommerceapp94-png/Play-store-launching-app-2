...
type Route = RouteProp<ContactsStackParamList, 'ContactsGroups'>;
...
export default function ContactsGroupsScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ContactsGroupDetail-0',
      label: "Engineering team",
      subtitle: "32 members",
      icon: "people-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsGroupDetail', { groupId: "g-0" }),
    },
    {
      key: 'ContactsGroupDetail-1',
      label: "Investors",
      subtitle: "12 members",
      icon: "briefcase" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsGroupDetail', { groupId: "g-1" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Contact groups</Text>
        <Text style={styles.heroSubtitle}>Organize contacts into named lists for faster meetings.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Contact groups</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Organize contacts into named lists for faster meetings. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsGroups • Page {page + 1}
        </Text>
      </View>
