...
type Route = RouteProp<ContactsStackParamList, 'ContactsImportSource'>;
...
export default function ContactsImportSourceScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ContactsIndex-0',
      label: "Done — return to contacts",
      subtitle: "See the imported contacts",
      icon: "checkmark-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsIndex'),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Import source</Text>
        <Text style={styles.heroSubtitle}>Authenticate and choose what to import.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Import source</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Authenticate and choose what to import. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsImportSource • Page {page + 1}
        </Text>
      </View>
