...
type Route = RouteProp<ContactsStackParamList, 'ContactsGroupMembers'>;
...
export default function ContactsGroupMembersScreen() {
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>CONTACTS • LEVEL 4</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Group members</Text>
        <Text style={styles.heroSubtitle}>All members of the selected group.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Group members</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>All members of the selected group. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsGroupMembers • Page {page + 1}
        </Text>
      </View>
