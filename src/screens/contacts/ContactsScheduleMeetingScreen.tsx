 ...
 *
 * Screen: ContactsScheduleMeeting
 * Stack:  contacts
 * Depth:  Level 3
 */
...
type Route = RouteProp<ContactsStackParamList, 'ContactsScheduleMeeting'>;
...
export default function ContactsScheduleMeetingScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ContactsScheduleConfirm-0',
      label: "Confirm Friday 4 PM",
      subtitle: "Sends invites instantly",
      icon: "checkmark-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsScheduleConfirm', { contactId: params.contactId as string, date: new Date().toISOString() }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Schedule a meeting</Text>
        <Text style={styles.heroSubtitle}>Pick a date — we\'ll handle invites and reminders.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Schedule a meeting</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Pick a date — we\'ll handle invites and reminders. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsScheduleMeeting • Page {page + 1}
        </Text>
      </View>
