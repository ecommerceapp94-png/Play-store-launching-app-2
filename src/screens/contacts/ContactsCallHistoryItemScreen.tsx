 ...
 *
 * Screen: ContactsCallHistoryItem
 * Stack:  contacts
 * Depth:  Level 4
 */
...
type Route = RouteProp<ContactsStackParamList, 'ContactsCallHistoryItem'>;
...
export default function ContactsCallHistoryItemScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Call history entry</Text>
        <Text style={styles.heroSubtitle}>Time, duration, recording, follow-ups.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Call history entry</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Time, duration, recording, follow-ups. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsCallHistoryItem • Page {page + 1}
        </Text>
      </View>
