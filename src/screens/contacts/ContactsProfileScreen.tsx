...
type Route = RouteProp<ContactsStackParamList, 'ContactsProfile'>;
...
export default function ContactsProfileScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ContactsScheduleMeeting-0',
      label: "Schedule a meeting",
      subtitle: "Pick a date and time together",
      icon: "calendar" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsScheduleMeeting', { contactId: params.contactId as string }),
    },
    {
      key: 'ContactsRecentMeetings-1',
      label: "Recent meetings",
      subtitle: "Calls you have had together",
      icon: "time" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsRecentMeetings', { contactId: params.contactId as string }),
    },
    {
      key: 'ContactsSharedFiles-2',
      label: "Shared files",
      subtitle: "Decks, docs, recordings",
      icon: "documents" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsSharedFiles', { contactId: params.contactId as string }),
    },
    {
      key: 'ContactsOptions-3',
      label: "Edit / delete / block",
      subtitle: "Manage this contact",
      icon: "options" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsOptions', { contactId: params.contactId as string }),
    },
  ];
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>CONTACTS • LEVEL 2</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Contact profile</Text>
        <Text style={styles.heroSubtitle}>Name, email, recent meetings, shared files.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Contact profile</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Name, email, recent meetings, shared files. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsProfile • Page {page + 1}
        </Text>
      </View>
