 ...
 *
 * Screen: ContactsScheduleConfirm
 * Stack:  contacts
 * Depth:  Level 4
 */
...
type Route = RouteProp<ContactsStackParamList, 'ContactsScheduleConfirm'>;
...
export default function ContactsScheduleConfirmScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Confirm meeting</Text>
        <Text style={styles.heroSubtitle}>Review and tap send to deliver invites.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Confirm meeting</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Review and tap send to deliver invites. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsScheduleConfirm • Page {page + 1}
        </Text>
      </View>
