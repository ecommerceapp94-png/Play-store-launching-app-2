...
type Route = RouteProp<ContactsStackParamList, 'ContactsDelete'>;
...
export default function ContactsDeleteScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ContactsIndex-0',
      label: "Cancel",
      subtitle: "Return to all contacts",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Delete contact</Text>
        <Text style={styles.heroSubtitle}>This action cannot be undone.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Delete contact</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>This action cannot be undone. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsDelete • Page {page + 1}
        </Text>
      </View>
