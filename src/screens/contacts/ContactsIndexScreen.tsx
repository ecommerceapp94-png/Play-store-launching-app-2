...
type Route = RouteProp<ContactsStackParamList, 'ContactsIndex'>;
...
export default function ContactsIndexScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ContactsAlphaSection-0',
      label: "Jump to A",
      subtitle: "24 contacts in section A",
      icon: "arrow-down" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsAlphaSection', { letter: "A" }),
    },
    {
      key: 'ContactsAlphaSection-1',
      label: "Jump to S",
      subtitle: "32 contacts in section S",
      icon: "arrow-down" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsAlphaSection', { letter: "S" }),
    },
    {
      key: 'ContactsAddNew-2',
      label: "Add new contact",
      subtitle: "Manual entry, business card scan or import",
      icon: "person-add" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsAddNew'),
    },
    {
      key: 'ContactsImport-3',
      label: "Import from elsewhere",
      subtitle: "CSV, vCard, Google, LinkedIn",
      icon: "cloud-download" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsImport'),
    },
    {
      key: 'ContactsGroups-4',
      label: "Manage groups",
      subtitle: "Organize people into named lists",
      icon: "people-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsGroups'),
    },
  ];
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>CONTACTS • LEVEL 1</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroSubtitle}>Search, browse alphabetically, organize into groups.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Contacts</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Search, browse alphabetically, organize into groups. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsIndex • Page {page + 1}
        </Text>
      </View>
