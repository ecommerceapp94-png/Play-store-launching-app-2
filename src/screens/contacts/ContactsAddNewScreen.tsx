...
type Route = RouteProp<ContactsStackParamList, 'ContactsAddNew'>;
...
export default function ContactsAddNewScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ContactsImport-0',
      label: "Import instead",
      subtitle: "Bulk add from a list",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Manual entry or scan a business card.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Add a new contact</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Manual entry or scan a business card. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsAddNew • Page {page + 1}
        </Text>
      </View>
