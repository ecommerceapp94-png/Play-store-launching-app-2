...
type Route = RouteProp<ContactsStackParamList, 'ContactsRecentMeetings'>;
...
export default function ContactsRecentMeetingsScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ContactsCallHistoryItem-0',
      label: "Open last call",
      subtitle: "Duration, recording link",
      icon: "call" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsCallHistoryItem', { contactId: params.contactId as string, index: 0 }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Recent meetings together</Text>
        <Text style={styles.heroSubtitle}>Calls you have had with this person.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Recent meetings together</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Calls you have had with this person. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsRecentMeetings • Page {page + 1}
        </Text>
      </View>
