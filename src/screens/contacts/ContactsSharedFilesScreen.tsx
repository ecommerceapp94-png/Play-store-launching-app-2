...
type Route = RouteProp<ContactsStackParamList, 'ContactsSharedFiles'>;
...
export default function ContactsSharedFilesScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ContactsSharedFile-0',
      label: "Open spec.pdf",
      subtitle: "Latest version",
      icon: "document" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsSharedFile', { contactId: params.contactId as string, fileId: "f-0" }),
    },
    {
      key: 'ContactsSharedFile-1',
      label: "Open metrics.png",
      subtitle: "Shared yesterday",
      icon: "image" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsSharedFile', { contactId: params.contactId as string, fileId: "f-1" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Shared files</Text>
        <Text style={styles.heroSubtitle}>Documents shared with this person across meetings.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Shared files</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Documents shared with this person across meetings. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsSharedFiles • Page {page + 1}
        </Text>
      </View>
