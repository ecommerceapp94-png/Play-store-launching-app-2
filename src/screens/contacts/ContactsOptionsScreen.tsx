...
type Route = RouteProp<ContactsStackParamList, 'ContactsOptions'>;
...
export default function ContactsOptionsScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ContactsEdit-0',
      label: "Edit contact",
      subtitle: "Update name, email, photo, notes",
      icon: "create" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsEdit', { contactId: params.contactId as string }),
    },
    {
      key: 'ContactsBlock-1',
      label: "Block contact",
      subtitle: "They can no longer ring you",
      icon: "ban" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsBlock', { contactId: params.contactId as string }),
    },
    {
      key: 'ContactsDelete-2',
      label: "Delete contact",
      subtitle: "Permanently remove",
      icon: "trash" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsDelete', { contactId: params.contactId as string }),
    },
  ];
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>CONTACTS • LEVEL 3</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Contact options</Text>
        <Text style={styles.heroSubtitle}>Edit info, block, or delete the contact.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Contact options</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Edit info, block, or delete the contact. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsOptions • Page {page + 1}
        </Text>
      </View>
