...
type Route = RouteProp<ContactsStackParamList, 'ContactsTagDetail'>;
...
export default function ContactsTagDetailScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Tag detail</Text>
        <Text style={styles.heroSubtitle}>All contacts that share this tag.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Tag detail</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>All contacts that share this tag. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsTagDetail • Page {page + 1}
        </Text>
      </View>
