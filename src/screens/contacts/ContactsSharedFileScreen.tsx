...
type Route = RouteProp<ContactsStackParamList, 'ContactsSharedFile'>;
...
export default function ContactsSharedFileScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ContactsSharedFiles-0',
      label: "Back to files",
      subtitle: "All shared documents",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Shared file</Text>
        <Text style={styles.heroSubtitle}>Preview, download, comment.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Shared file</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Preview, download, comment. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsSharedFile • Page {page + 1}
        </Text>
      </View>
