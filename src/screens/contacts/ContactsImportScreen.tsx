...
type Route = RouteProp<ContactsStackParamList, 'ContactsImport'>;
...
export default function ContactsImportScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ContactsImportSource-0',
      label: "From Google",
      subtitle: "OAuth, secure, fast",
      icon: "logo-google" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsImportSource', { source: "google" }),
    },
    {
      key: 'ContactsImportSource-1',
      label: "From CSV",
      subtitle: "Drop a CSV from your computer",
      icon: "document" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsImportSource', { source: "csv" }),
    },
    {
      key: 'ContactsImportSource-2',
      label: "From LinkedIn",
      subtitle: "Connect via LinkedIn API",
      icon: "logo-linkedin" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsImportSource', { source: "linkedin" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Import contacts</Text>
        <Text style={styles.heroSubtitle}>Pick where your contacts live and we\'ll import them.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Import contacts</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Pick where your contacts live and we\'ll import them. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsImport • Page {page + 1}
        </Text>
      </View>
