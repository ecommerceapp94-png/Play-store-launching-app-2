...
type Route = RouteProp<ContactsStackParamList, 'ContactsEdit'>;
...
export default function ContactsEditScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Update fields and tap save.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Edit contact</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Update fields and tap save. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsEdit • Page {page + 1}
        </Text>
      </View>
