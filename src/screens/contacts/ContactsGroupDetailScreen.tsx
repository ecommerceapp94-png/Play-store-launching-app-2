...
type Route = RouteProp<ContactsStackParamList, 'ContactsGroupDetail'>;
...
export default function ContactsGroupDetailScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ContactsGroupMembers-0',
      label: "See all members",
      subtitle: "Tap any member to open profile",
      icon: "people" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsGroupMembers', { groupId: params.groupId as string }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Group detail</Text>
        <Text style={styles.heroSubtitle}>See members and message everyone at once.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Group detail</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>See members and message everyone at once. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsGroupDetail • Page {page + 1}
        </Text>
      </View>
