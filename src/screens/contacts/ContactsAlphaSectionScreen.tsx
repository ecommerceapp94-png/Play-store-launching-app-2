...
type Route = RouteProp<ContactsStackParamList, 'ContactsAlphaSection'>;
...
export default function ContactsAlphaSectionScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'ContactsProfile-0',
      label: "Open first contact",
      subtitle: "Full profile",
      icon: "person" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsProfile', { contactId: "c-0" }),
    },
    {
      key: 'ContactsProfile-1',
      label: "Open second contact",
      subtitle: "Full profile",
      icon: "person" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsProfile', { contactId: "c-1" }),
    },
    {
      key: 'ContactsTagDetail-2',
      label: "See tag: Investor",
      subtitle: "Browse by label",
      icon: "pricetag" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('ContactsTagDetail', { tag: "Investor" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Alphabetical section</Text>
        <Text style={styles.heroSubtitle}>All contacts that start with this letter.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Alphabetical section</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>All contacts that start with this letter. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • contacts ContactsAlphaSection • Page {page + 1}
        </Text>
      </View>
