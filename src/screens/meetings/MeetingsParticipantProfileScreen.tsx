 ...
 *
 * Screen: MeetingsParticipantProfile
 * Stack:  meetings
 * Depth:  Level 4
 */
...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsParticipantProfile'>;
...
export default function MeetingsParticipantProfileScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsChatThread-0',
      label: "Send a quick message",
      subtitle: "Whisper before the meeting",
      icon: "chatbubble" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsChatThread', { meetingId: params.meetingId as string, messageId: "m-0" }),
    },
    {
      key: 'MeetingsParticipantsList-1',
      label: "Back to participants",
      subtitle: "See everyone in the room",
    ...
    },
    {
      ...
      label: "See participation history",
      subtitle: "How active they've been recently",
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>MEETINGS • LEVEL 4</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Participant profile</Text>
        <Text style={styles.heroSubtitle}>Profile card with contact options & recent meetings.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Participant profile</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Profile card with contact options & recent meetings. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsParticipantProfile • Page {page + 1}
        </Text>
      </View>
