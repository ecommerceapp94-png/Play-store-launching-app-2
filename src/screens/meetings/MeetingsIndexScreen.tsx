...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsIndex'>;
...
export default function MeetingsIndexScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsUpcomingDetail-0',
      label: "Today's standup",
      subtitle: "Sync with the engineering pod",
      icon: "sunny" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsUpcomingDetail', { meetingId: "m-0" }),
    },
    {
      key: 'MeetingsUpcomingDetail-1',
      label: "Quarterly review",
      subtitle: "Quarter-over-quarter results",
      icon: "trending-up" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsUpcomingDetail', { meetingId: "m-1" }),
    },
    {
      key: 'MeetingsPastDetail-2',
      label: "Yesterday's 1:1",
      subtitle: "Action items recap",
      icon: "time" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsPastDetail', { meetingId: "m-2" }),
    },
    {
      key: 'MeetingsRecordings-3',
      label: "Latest recordings",
      subtitle: "Replay anything missed",
      icon: "film" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsRecordings', { meetingId: "m-0" }),
    },
  ];

  const heroGradient = theme.colors.heroGradient;
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>MEETINGS • LEVEL 1</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Your meetings</Text>
        <Text style={styles.heroSubtitle}>Upcoming, recurring, and past — all in one place.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Your meetings</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Upcoming, recurring, and past — all in one place. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsIndex • Page {page + 1}
        </Text>
      </View>
