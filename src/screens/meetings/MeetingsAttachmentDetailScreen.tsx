 ...
 *
 * Screen: MeetingsAttachmentDetail
 * Stack:  meetings
 * Depth:  Level 4
 */
...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsAttachmentDetail'>;
...
export default function MeetingsAttachmentDetailScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsAttachments-0',
      label: "Back to all attachments",
      subtitle: "See the rest of the documents",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Attachment</Text>
        <Text style={styles.heroSubtitle}>Preview, comment, share, version history.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Attachment</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Preview, comment, share, version history. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsAttachmentDetail • Page {page + 1}
        </Text>
      </View>
