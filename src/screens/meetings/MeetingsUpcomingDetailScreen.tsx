...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsUpcomingDetail'>;
...
export default function MeetingsUpcomingDetailScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsParticipantsList-0',
      label: "See participants",
      subtitle: "Who's coming and their roles",
      icon: "people" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsParticipantsList', { meetingId: params.meetingId as string }),
    },
    {
      key: 'MeetingsAgenda-1',
      label: "Open agenda",
      subtitle: "Topics, owners, and timing",
      icon: "list" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsAgenda', { meetingId: params.meetingId as string }),
    },
    {
      key: 'MeetingsChat-2',
      label: "Pre-meeting chat",
      subtitle: "Notes from before the meeting",
      icon: "chatbubbles" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsChat', { meetingId: params.meetingId as string }),
    },
    {
      key: 'MeetingsExportShare-3',
      label: "Share details",
      subtitle: "Send invite to extra guests",
      icon: "share" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsExportShare', { meetingId: params.meetingId as string }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Upcoming meeting</Text>
        <Text style={styles.heroSubtitle}>Time, room, agenda, and the people involved.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Upcoming meeting</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Time, room, agenda, and the people involved. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsUpcomingDetail • Page {page + 1}
        </Text>
      </View>
