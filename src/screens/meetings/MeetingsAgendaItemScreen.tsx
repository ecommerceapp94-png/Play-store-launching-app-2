...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsAgendaItem'>;
...
export default function MeetingsAgendaItemScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      onPress: () => navigation.navigate('MeetingsTask', { meetingId: params.meetingId as string, taskId: "t-0" }),
    },
    {
      key: 'MeetingsAgenda-1',
      label: "Back to agenda",
      subtitle: "View the full plan",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Agenda item</Text>
        <Text style={styles.heroSubtitle}>Owner, timing, notes, attached docs.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Agenda item</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Owner, timing, notes, attached docs. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsAgendaItem • Page {page + 1}
        </Text>
      </View>
