 ...
 *
 * Screen: MeetingsParticipantsList
 * Stack:  meetings
 * Depth:  Level 3
 */
...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsParticipantsList'>;
...
export default function MeetingsParticipantsListScreen() {
  ...
  const items = state.contacts.slice(0, 12);
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsParticipantProfile-0',
      label: "Open Aditya's profile",
      subtitle: "Full profile with contact options",
      icon: "person-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsParticipantProfile', { meetingId: params.meetingId as string, participantId: "c-0" }),
    },
    {
      key: 'MeetingsParticipantProfile-1',
      label: "Open Priya's profile",
      subtitle: "Full profile with contact options",
      icon: "person-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsParticipantProfile', { meetingId: params.meetingId as string, participantId: "c-1" }),
    },
    {
      key: 'MeetingsAttachments-2',
      label: "Shared attachments",
      subtitle: "Files dropped during this meeting",
      icon: "attach" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsAttachments', { meetingId: params.meetingId as string }),
    },
  ];

  const heroGradient = theme.colors.contactsGradient;
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>MEETINGS • LEVEL 3</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Participants</Text>
        <Text style={styles.heroSubtitle}>Tap any name to dive into their profile.</Text>
        ...
        <View style={styles.heroStatsRow}>
          ...
          <View style={styles.heroStat}>
            <Text style={styles.heroStatValue}>3/4</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Participants</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Tap any name to dive into their profile. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsParticipantsList • Page {page + 1}
        </Text>
      </View>
