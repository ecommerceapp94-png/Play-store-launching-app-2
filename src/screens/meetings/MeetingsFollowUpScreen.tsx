...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsFollowUp'>;
...
export default function MeetingsFollowUpScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsTask-0',
      label: "Open task #1",
      subtitle: "See the full task description",
    ...
    },
    {
      key: 'MeetingsTask-1',
      label: "Open task #2",
      subtitle: "Owner: Aditya • Due Friday",
      icon: "checkmark-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsTask', { meetingId: params.meetingId as string, taskId: "t-1" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Action items, owners and due dates.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Follow-ups</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Action items, owners and due dates. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsFollowUp • Page {page + 1}
        </Text>
      </View>
