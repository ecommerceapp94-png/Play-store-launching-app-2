...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsChatThread'>;
...
export default function MeetingsChatThreadScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsChat-0',
      label: "Back to chat",
      subtitle: "See the main timeline",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Chat thread</Text>
        <Text style={styles.heroSubtitle}>A focused thread of replies, reactions and attachments.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Chat thread</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>A focused thread of replies, reactions and attachments. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsChatThread • Page {page + 1}
        </Text>
      </View>
