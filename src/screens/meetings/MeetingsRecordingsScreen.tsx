...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsRecordings'>;
...
export default function MeetingsRecordingsScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsRecordingPlayback-0',
      label: "Play full recording",
      subtitle: "Studio-quality playback with chapters",
      icon: "play" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsRecordingPlayback', { recordingId: "r-0" }),
    },
    {
      key: 'MeetingsTranscript-1',
      label: "Open transcript",
      subtitle: "Searchable text with sentiment",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Pick a recording to scrub through and share.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            ...
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Pick a recording to scrub through and share. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsRecordings • Page {page + 1}
        </Text>
      </View>
