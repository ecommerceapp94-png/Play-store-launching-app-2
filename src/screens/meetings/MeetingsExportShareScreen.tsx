...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsExportShare'>;
...
export default function MeetingsExportShareScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsExportShare-0',
      label: "Send to Slack #design",
      subtitle: "Posts the recap automatically",
    ...
    },
    {
      ...
      subtitle: "Share with anyone (read-only)",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Pick a destination — email, Slack, or a public link.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Export & share</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Pick a destination — email, Slack, or a public link. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsExportShare • Page {page + 1}
        </Text>
      </View>
