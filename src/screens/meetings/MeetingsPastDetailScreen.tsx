...
type Nav = NativeStackNavigationProp<MeetingsStackParamList>;
type Route = RouteProp<MeetingsStackParamList, 'MeetingsPastDetail'>;
...
export default function MeetingsPastDetailScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsRecordings-0',
      label: "Recordings",
      subtitle: "Watch the call back",
      icon: "film" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsRecordings', { meetingId: params.meetingId as string }),
    },
    {
      key: 'MeetingsTranscript-1',
      label: "Full transcript",
      subtitle: "Searchable, AI-summarised",
      icon: "document-text" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsTranscript', { meetingId: params.meetingId as string }),
    },
    {
      key: 'MeetingsAnalytics-2',
      label: "Talk-time analytics",
      subtitle: "Speaker share & sentiment",
      icon: "analytics" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsAnalytics', { meetingId: params.meetingId as string }),
    },
    {
      key: 'MeetingsFollowUp-3',
      label: "Follow-ups & tasks",
      subtitle: "Track every action item",
      icon: "list-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsFollowUp', { meetingId: params.meetingId as string }),
    },
  ];

  const heroGradient = theme.colors.recordingGradient;
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.heroCaption}>MEETINGS • LEVEL 2</Text>
          </View>
          <AnimatedPressable
        ...
        <Text style={styles.heroTitle}>Past meeting</Text>
        <Text style={styles.heroSubtitle}>Recap, recordings, action items and follow-ups.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Past meeting</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Recap, recordings, action items and follow-ups. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsPastDetail • Page {page + 1}
        </Text>
      </View>
