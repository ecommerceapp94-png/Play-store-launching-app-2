 ...
 *
 * Screen: MeetingsTranscriptSegment
 * Stack:  meetings
 * Depth:  Level 4
 */
...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsTranscriptSegment'>;
...
export default function MeetingsTranscriptSegmentScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Speaker, sentiment and a jump-to-time button.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            ...
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Speaker, sentiment and a jump-to-time button. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsTranscriptSegment • Page {page + 1}
        </Text>
      </View>
