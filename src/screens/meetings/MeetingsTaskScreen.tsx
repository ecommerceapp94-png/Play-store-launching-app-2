...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsTask'>;
...
export default function MeetingsTaskScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsFollowUp-0',
      label: "Back to follow-ups",
      subtitle: "See all action items",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroSubtitle}>Owner, due date, conversation history, status.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Task detail</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Owner, due date, conversation history, status. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsTask • Page {page + 1}
        </Text>
      </View>
