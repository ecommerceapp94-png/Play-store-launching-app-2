...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsChat'>;
...
export default function MeetingsChatScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      ...
      label: "Open a thread",
      subtitle: "See the conversation that branched off",
      icon: "chatbubbles" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsChatThread', { meetingId: params.meetingId as string, messageId: "ch-0" }),
    },
    {
      key: 'MeetingsAttachments-1',
      label: "Shared files",
      subtitle: "Documents dropped in chat",
      icon: "document-attach" as keyof typeof Ionicons.glyphMap,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Meeting chat</Text>
        <Text style={styles.heroSubtitle}>Backchannel messages and reactions during this call.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Meeting chat</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Backchannel messages and reactions during this call. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsChat • Page {page + 1}
        </Text>
      </View>
