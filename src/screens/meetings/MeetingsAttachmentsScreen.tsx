...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsAttachments'>;
...
export default function MeetingsAttachmentsScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsAttachmentDetail-0',
      label: "Open spec.pdf",
      subtitle: "Preview and download options",
      icon: "document" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsAttachmentDetail', { meetingId: params.meetingId as string, attachmentId: "att-0" }),
    },
    {
      key: 'MeetingsAttachmentDetail-1',
      label: "Open metrics.png",
      subtitle: "Open the dashboard screenshot",
      icon: "image" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsAttachmentDetail', { meetingId: params.meetingId as string, attachmentId: "att-1" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Attachments</Text>
        <Text style={styles.heroSubtitle}>Files shared in this meeting and during follow-ups.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Attachments</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Files shared in this meeting and during follow-ups. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsAttachments • Page {page + 1}
        </Text>
      </View>
