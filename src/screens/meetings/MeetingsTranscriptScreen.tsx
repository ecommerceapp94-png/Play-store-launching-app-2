...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsTranscript'>;
...
export default function MeetingsTranscriptScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsTranscriptSegment-0',
      label: "Open segment 1",
      subtitle: "Speaker identified, AI summary",
      icon: "play-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsTranscriptSegment', { meetingId: params.meetingId as string, segmentId: "s-0" }),
    },
    {
      key: 'MeetingsTranscriptSegment-1',
      label: "Open segment 2",
      subtitle: "Decisions captured here",
      icon: "play-circle" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsTranscriptSegment', { meetingId: params.meetingId as string, segmentId: "s-1" }),
    },
  ];

  const heroGradient = theme.colors.aiGradient;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Meeting transcript</Text>
        <Text style={styles.heroSubtitle}>AI-generated, searchable transcript with timestamps.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Meeting transcript</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>AI-generated, searchable transcript with timestamps. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsTranscript • Page {page + 1}
        </Text>
      </View>
