...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsAgenda'>;
...
export default function MeetingsAgendaScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsAgendaItem-0',
      label: "Open: Set the stage",
      subtitle: "Owner notes and timing",
      icon: "flag" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsAgendaItem', { meetingId: params.meetingId as string, itemId: "a-0" }),
    },
    {
      key: 'MeetingsAgendaItem-1',
      label: "Open: Decisions to make",
      subtitle: "Vote and capture outcomes",
      icon: "checkmark-done" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsAgendaItem', { meetingId: params.meetingId as string, itemId: "a-1" }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Meeting agenda</Text>
        <Text style={styles.heroSubtitle}>Topics, owners, and a tap-through view of every item.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Meeting agenda</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Topics, owners, and a tap-through view of every item. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsAgenda • Page {page + 1}
        </Text>
      </View>
