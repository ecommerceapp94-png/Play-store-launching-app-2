...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsAnalytics'>;
...
export default function MeetingsAnalyticsScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsAnalytics-0',
      label: "Compare with last week",
      subtitle: "Trend the data",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Meeting analytics</Text>
        <Text style={styles.heroSubtitle}>Speaker share, sentiment, recurring topics.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Meeting analytics</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Speaker share, sentiment, recurring topics. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsAnalytics • Page {page + 1}
        </Text>
      </View>
