 ...
 *
 * Screen: MeetingsRecordingPlayback
 * Stack:  meetings
 * Depth:  Level 4
 */
...
type Route = RouteProp<MeetingsStackParamList, 'MeetingsRecordingPlayback'>;
...
export default function MeetingsRecordingPlaybackScreen() {
  ...
  const nextRoutes: Array<{ key: string; label: string; subtitle: string; icon: keyof typeof Ionicons.glyphMap; onPress: () => void }> = [
    {
      key: 'MeetingsTranscript-0',
      label: "See transcript",
      subtitle: "Read alongside the audio",
      icon: "document-text" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsTranscript', { meetingId: params.recordingId as string }),
    },
    {
      key: 'MeetingsExportShare-1',
      label: "Share recording",
      subtitle: "Email, link, or to a Slack channel",
      icon: "share-social" as keyof typeof Ionicons.glyphMap,
      onPress: () => navigation.navigate('MeetingsExportShare', { meetingId: params.recordingId as string }),
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.heroTitle}>Recording playback</Text>
        <Text style={styles.heroSubtitle}>Scrub, share, jump to chapters.</Text>
      ...
      <View style={styles.glassCardWrap}>
        <GlassCard borderRadius={22}>
          <View style={styles.glassCardInner}>
            <Text style={[styles.cardTitle, { color: theme.colors.textPrimary }]}>Recording playback</Text>
            <Text style={[styles.cardCaption, { color: theme.colors.textSecondary }]}>Scrub, share, jump to chapters. Tap any tile below to keep diving.</Text>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        >
          MeetX Ultra Pro • {resolvedName} mode • meetings MeetingsRecordingPlayback • Page {page + 1}
        </Text>
      </View>
